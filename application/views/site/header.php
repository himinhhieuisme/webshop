<div class="row" style="margin-top: 0px;height: 240px">
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-3 clearpadding">
			...
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 clearpadding">
				<a href="#"><img style="max-height: 230px;width: 100%" src="<?php echo base_url(); ?>upload/banner3.png" alt="" class="img-responsive"></a>
			</div>
		</div>
		<div class="row">
